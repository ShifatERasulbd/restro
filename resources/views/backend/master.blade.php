          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('sliders')}}">All Slider</a></li>
                <li><a class="nav-link" href="{{route('sliders.create')}}">Add Slider</a></li>
              </ul>
            </li>
            <li><a class="nav-link" href="{{route('aboutUs')}}"><i data-feather="file"></i><span>About Us</span></a></li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Offer</span></a>
              <ul class="dropdown-menu">
             
                <li><a class="nav-link" href="{{route('orderDesign')}}">All Offer</a></li>
                <li><a class="nav-link" href="{{ route('orderDesign.create') }}">Add Offer</a></li>
           
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Customer Review</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('customerReview') }}">All Review</a></li>
                <li><a class="nav-link" href="{{ route('customerReview.create') }}">Add Review</a></li>
      
              </ul>
            </li>
            
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="copy"></i><span>Gallery</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('gallery')}}">All Image</a></li>
                <li><a class="nav-link" href="{{ route('gallery.create') }}">Add Image</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="shopping-bag"></i><span>Food Menu</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('foodCategory')}}">Foood Category</a></li>
                <li><a class="nav-link" href="{{route('foodCategory.create')}}">Create Food Category</a></li>
                <li><a class="nav-link" href="{{route('food')}}">Food</a></li>
                <li><a class="nav-link" href="{{route('food.create')}}">Add Food Menu</a></li>
                <li><a class="nav-link" href="{{route('sauces')}}">Sauces</a></li>
                <li><a class="nav-link" href="{{route('sauces.create')}}">Add Sauces</a></li>
